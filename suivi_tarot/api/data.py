...
from suivi_tarot.api.calcul import repartition_points_by_player, calcul_donne
from suivi_tarot.database.clients import get_distinct_player, get_donne, get_preneur, get_appele, get_defense, get_pnj


class Data:
    """Récupération et prétraitement des données relativent aux parties jouées pour un
