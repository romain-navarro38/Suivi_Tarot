...
from suivi_tarot.api.utils import SUB_STATISTICS, MAIN_STATISTICS, GENERAL_STATISTICS
...
class Statistic(Data):
    ...
    def stat_formatting(self):
        """Prépare le dictionnaire stockant les statistiques"""
        ...
        for player in self.distinct_player:
            self.stat[player].update(MAIN_STATISTICS)

        self.stat["_global"] = GENERAL_STATISTICS
